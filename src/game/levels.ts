...
export const LEVELS: LevelData[] = [
  ...
  // Level 31: Oasis Outpost
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 5, z: 15 }, hp: 60, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 18, z: 18 }, hp: 60, weapon: { ...rifle } },
    ],
  ...
  // Level 32: Canyon Pass
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 20, z: 6 }, hp: 80, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 6, z: 2 }, hp: 50, weapon: { ...shotgun } },
    ],
  ...
  // Level 33: Dune Fort
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 10, z: 5 }, hp: 80, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 5, z: 10 }, hp: 60, weapon: { ...shotgun } },
      { id: 'de5', pos: { x: 15, z: 10 }, hp: 60, weapon: { ...shotgun } },
    ],
  ...
  // Level 34: Sandstorm Station
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 2, z: 12 }, hp: 60, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 16, z: 12 }, hp: 60, weapon: { ...rifle } },
      { id: 'de5', pos: { x: 9, z: 6 }, hp: 80, weapon: { ...shotgun } },
    ],
  ...
  // Level 35: Dust Pit
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 14, z: 7 }, hp: 70, weapon: { ...shotgun } },
      { id: 'de4', pos: { x: 6, z: 3 }, hp: 50, weapon: { ...rifle } },
      { id: 'de5', pos: { x: 6, z: 11 }, hp: 50, weapon: { ...rifle } },
    ],
  ...
  // Level 36: Arid Arena
  {
    ...
    enemies: [
      { id: 'de1', pos: { x: 2, z: 2 }, hp: 60, weapon: { ...rifle } },
      { id: 'de2', pos: { x: 18, z: 2 }, hp: 60, weapon: { ...rifle } },
      { id: 'de3', pos: { x: 2, z: 18 }, hp: 60, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 18, z: 18 }, hp: 60, weapon: { ...rifle } },
      { id: 'de5', pos: { x: 10, z: 2 }, hp: 60, weapon: { ...rifle } },
      { id: 'de6', pos: { x: 10, z: 18 }, hp: 60, weapon: { ...rifle } },
    ],
  ...
  // Level 37: Scorpion Nest
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 2, z: 20 }, hp: 60, weapon: { ...shotgun } },
      { id: 'de4', pos: { x: 11, z: 5 }, hp: 60, weapon: { ...rifle } },
      { id: 'de5', pos: { x: 5, z: 11 }, hp: 60, weapon: { ...rifle } },
      { id: 'de6', pos: { x: 11, z: 17 }, hp: 60, weapon: { ...rifle } },
      { id: 'de7', pos: { x: 17, z: 11 }, hp: 60, weapon: { ...rifle } },
    ],
  ...
  // Level 38: Heat Haze
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 13, z: 5 }, hp: 60, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 3, z: 20 }, hp: 60, weapon: { ...shotgun } },
      { id: 'de5', pos: { x: 13, z: 20 }, hp: 60, weapon: { ...shotgun } },
      { id: 'de6', pos: { x: 8, z: 10 }, hp: 80, weapon: { ...rifle } },
    ],
    barrels: [],
  ...
  // Level 39: Mirage Mesa
  {
    ...
    enemies: [
      ...
      { id: 'de3', pos: { x: 2, z: 22 }, hp: 80, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 12, z: 6 }, hp: 70, weapon: { ...shotgun } },
      { id: 'de5', pos: { x: 6, z: 12 }, hp: 70, weapon: { ...shotgun } },
      { id: 'de6', pos: { x: 18, z: 12 }, hp: 70, weapon: { ...shotgun } },
      { id: 'de7', pos: { x: 12, z: 18 }, hp: 70, weapon: { ...shotgun } },
    ],
  ...
  // Level 40: Emperor of the Dunes
  {
    ...
    enemies: [
      ...
      { id: 'de2', pos: { x: 23, z: 3 }, hp: 100, weapon: { ...rifle } },
      { id: 'de3', pos: { x: 3, z: 23 }, hp: 100, weapon: { ...rifle } },
      { id: 'de4', pos: { x: 23, z: 23 }, hp: 100, weapon: { ...rifle } },
      { id: 'de5', pos: { x: 8, z: 8 }, hp: 80, weapon: { ...shotgun } },
      { id: 'de6', pos: { x: 18, z: 8 }, hp: 80, weapon: { ...shotgun } },
