...
export const LEVELS_2: LevelData[] = [
  ...
  // Level 60: Leviathan — Ultimate boss battle, 30x30, 2000 HP boss, 9 guards, 5 turrets
  {
    ...
    enemies: [
      { id: 'beach_boss', pos: { x: 15, z: 3 }, hp: 1400, weapon: { ...rifle, damage: 45, ammo: 9999, maxAmmo: 9999 }, color: '#3b82f6' },
    ...
    turrets: [
      { id: 'bt1', pos: { x: 5, z: 10 }, hp: 400, damage: 25, fireRate: 800, color: '#3b82f6' },
      { id: 'bt2', pos: { x: 24, z: 10 }, hp: 400, damage: 25, fireRate: 800, color: '#3b82f6' },
      { id: 'bt3', pos: { x: 15, z: 20 }, hp: 400, damage: 25, fireRate: 800, color: '#3b82f6' },
      { id: 'bt4', pos: { x: 10, z: 5 }, hp: 400, damage: 25, fireRate: 1200, color: '#3b82f6' },
      { id: 'bt5', pos: { x: 19, z: 5 }, hp: 400, damage: 25, fireRate: 1200, color: '#3b82f6' },
    ],
    buttons: [
    ...
    barrels: [
      ...
      { id: 'bb60_8', pos: { x: 15, z: 4 } }, { id: 'bb60_9', pos: { x: 14, z: 4 } }, { id: 'bb60_10', pos: { x: 16, z: 4 } },
    ],
    ...
    ammoBoxes: [
      ...
      { id: 'ba60_5', pos: { x: 2, z: 2 } }, { id: 'ba60_6', pos: { x: 27, z: 28 } }, { id: 'ba60_7', pos: { x: 15, z: 22 } },
    ],
    exit: { x: 15, z: 1 },
  },
  // ============================================
